    ...
    public static void SV_HueckHaupt(int arr_pos) {
        switch (arr_pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("Der Ball kommt! Er fliegt von links! Aber was ist das - rechts daneben? Da kommt eine Gitarre! Eine Gitarre! Sie fliegt und trifft den Ball! Die Gittare ist jetzt zwar kaputt, aber dafür wurde der Ball gut abgewehrt durch Franziska Schepers vom SV!");
                break;
            case 5:
