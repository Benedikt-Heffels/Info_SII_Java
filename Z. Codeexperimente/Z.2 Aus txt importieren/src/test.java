//https://www.youtube.com/watch?v=PmJcd9ZyBf4
...
public class test {
    public static void main(String[] args) {
        // Path path = Path.of("D:/JavaProjects/Info_SII_Java/test/src/txtdatei.txt");
        FileWriter writer;
        ...
        File datei = new File("Z. Codeexperimente/Z.2 Aus txt importieren/textdatei.txt");
        /*try {
