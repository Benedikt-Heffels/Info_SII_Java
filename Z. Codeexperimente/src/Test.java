...
//
//        }
        String kurseBenHef[] = {"ELemenent"};
        String gueltigeListe = "unkown";
        String gueltigerBN = "BenHef";
        gueltigeListe = "kurse" + gueltigerBN;
        System.out.println(gueltigeListe);
        System.out.println(gueltigeListe[0]);
        System.exit(1);
        String zahlstring = "22";
        int zahlint = Integer.valueOf (zahlstring);
